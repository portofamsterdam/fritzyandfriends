...
public enum ESolarEdgeRegister {
	/**
	 * SunSpec defined registers
	 * These registers have an offset of -1, this offset is already applied (For example, according to the documentation C_SUNSPEC_ID starts at address 40001)
	 */
